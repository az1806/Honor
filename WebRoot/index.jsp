<%@ page language="java" import="java.util.*,com.honor.entity.*"
	pageEncoding="utf-8"%>
<%
...
<body>
	...
	<div>
		<span> <article>公司介绍</article>
			<h6>COMPANY INTRODUCTION</h6> </span> <span> </span>
	</div>
	<div></div>
	<div class="about-content">
		...
		<article> <%
 	List<GongShi> gsList = (List<GongShi>) request.getAttribute("gs");

 	for (int i = 0; i < gsList.size(); i++) {
 %>
		<p><%=gsList.get(i).getJieshao()%></p>
