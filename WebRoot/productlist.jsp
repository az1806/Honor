<%@ page language="java" import="java.util.*, com.entity.ProductType;" pageEncoding="UTF-8"%>
<%
    ...
    <aside class="pro-leftsidebar">
        <ul>
            ...
            <li>
                <a>产品分类</a>
                <ul id="pro-category">
                <%    List<ProductType> pts = ( List<ProductType> ) request.getAttribute("productlist");
                   ...
                   for (int i=0;i<pts.size();i++) {
                     ...
                     <li class="on"><a href="#"><%=pts.get(i).getType() %></a></li>
